  ...
  <div class="Container">
    <div class="Tag-root">
      ...
      <ul class="list-tag">
        <li>
          <div class="tag-img">
            <img src="https://www.kindpng.com/picc/m/43-435202_fresh-healthy-food-png-free-download-transparent-background.png" alt="">
          </div>
          <span>Thực phẩm</span>
        </li>
        <li>
          <div class="tag-img">
            <img src="https://binbadecor.com.vn/wp-content/uploads/2020/10/thi%E1%BA%BFt-k%E1%BA%BF-shop-qu%E1%BA%A7n-%C3%A1o-8.jpg" alt="">
          </div>
          <span>Quần áo</span>
        </li>
        <li>
          <div class="tag-img">
            <img src="https://cdn.vuahanghieu.com/unsafe/0x900/left/top/smart/filters:quality(90)/https://admin.vuahanghieu.com/upload/product/2019/08/balo-lacoste-men-s-neocroc-canvas-backpack-5d5bbdb84d190-20082019163032.png" alt="">
          </div>
          <span>Balo</span>
        </li>
        <li>
          <div class="tag-img">
            <img src="https://kienviet.net/wp-content/uploads/2019/09/cropped-noi-that-dong-gia-1-1440x809.jpg" alt="">
          </div>
          <span>Nội thất</span>
        </li>
        <li>
          <div class="tag-img">
            <img src="https://matika.vn/wp-content/uploads/2019/01/nang-tam-can-bep-viet-voi-4-mon-do-gia-dung-matika.jpg" alt="">
          </div>
          ...
          <ul>
            <li class="main-product">
              <div class="img-product">
                <img class="img-prd"
                     src="https://bizweb.dktcdn.net/thumb/large/100/228/168/products/sualai.jpg?v=1573720306000" alt="">
              </div>
